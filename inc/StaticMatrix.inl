...
staticMat<T, M, N>::staticMat() :
		staticVec<staticVec<T, N>, M>(), m_trans(false) {
}

template<class T, size_t M, size_t N>
staticMat<T, M, N>::staticMat(const staticVec<T, N> &v, bool t) :
		staticVec<staticVec<T, N>, M>(v), m_trans(t) {
}

template<class T, size_t M, size_t N>
staticMat<T, M, N>::staticMat(const staticVec<T, N> &v,
		const staticVec<T, N> &u, bool t) :
...
template<class T, size_t M, size_t N>
staticMat<T, M, N>::staticMat(const staticVec<T, N> &v,
		const staticVec<T, N> &u, const staticVec<T, N> &w, bool t) :
		staticVec<staticVec<T, N>, M>(), m_trans(t) {
	(*this)[0] = v;
	(*this)[1] = u;
	(*this)[2] = w;
...
template<class T, size_t M, size_t N>
staticMat<T, M, N>::staticMat(const T &val, bool t) :
		staticVec<staticVec<T, N>, M>(), m_trans(t) {
...
template<class T, size_t M, size_t N>
staticMat<T, M, N>::staticMat(const staticVec<staticVec<T, N>, M> &vv, bool t) :
...
const staticMat<T, M, N>& staticMat<T, M, N>::operator=(
		const staticMat<T, M, N> &rhs) {
	if (this != &rhs) {
