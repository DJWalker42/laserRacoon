...
namespace phys{
	...
	*/
	...
	public:
		...
		int globalIdx() const {return m_globalIndex;}
	...
	*/
	...
	public:
		...
		{}
	public:
			double getX() const noexcept {return m_Xcoord;}
			double getY() const noexcept {return m_Ycoord;}
			int globalIdx() const noexcept {return m_globalIdx;}
	private:
		double m_Xcoord;
		double m_Ycoord;
		int m_globalIdx;
	...
	public:
		...
		int northIdx() const noexcept {return m_neighbour[NORTH];}
		int southIdx() const noexcept {return m_neighbour[SOUTH];}
		int eastIdx() const noexcept {return m_neighbour[EAST];}
		int westIdx() const noexcept {return m_neighbour[WEST];}
